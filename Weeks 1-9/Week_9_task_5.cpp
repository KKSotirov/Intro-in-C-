...
// Проверка за симетричност спрямо главния диагонал
bool isSymmetric(const int *const *matrix, size_t n)
{
    for (size_t i = 0; i < n; i++)
    {
...
int main()
{
    ...
    // 5. Проверка и извеждане на резултата
